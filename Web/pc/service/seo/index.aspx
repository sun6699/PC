<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Tc.Web.m.service.seo.index" %>
...
<body>
    ...
    <section id="single">
        ...
        <div class="cat_title">
            <div class="wrapper">
                <h2><strong>SERVICE</strong>服务</h2>
        ...
        <div class="category">
            <div class="wrapper">
                ...
                <ul class="catbtn">
                    ...
                    <li><a href="index.htm"  class='cur'>seo优化推广</a></li>
    ...
    <footer>
        ...
        <div id="footerinfo">
            <div class="wrapper">
                ...
                <p>
                    <a target="_blank" href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=429592913&site=qq&menu=yes  点击这里和我聊天'))window.location='http://wpa.qq.com/msgrd?v=3&uin=429592913&site=qq&menu=yes'" tppabs="http://wpa.qq.com/msgrd?v=3&uin=429592913&site=qq&menu=yes"><img border="0" src="../../assets/images/qq.png"  alt="点击这里给我发消息" title="点击这里给我发消息" /></a><br />
                    电话：400 8888 8888<br />
                    传真：400 8888 8888<br />
                    电子邮件：admin@u.com<br />
