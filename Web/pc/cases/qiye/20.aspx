<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="20.aspx.cs" Inherits="Tc.Web.m.cases.qiye._20" %>
	...
	<article>
		<div class="wrapper">
			<div id="overview">
				...
				<div id="case_info">
																																							<h1><img src="../../assets/uploads/131102/1-13110221000L92.png" tppabs="http://mc18.eatdou.com/uploads/131102/1-13110221000L92.png" width="180" height="120" alt="优品道控股" /></h1>
					<ul>
						<li>名称：优品道控股</li>
						<li>分类：企业官网</li>
						<li>TAG：食品优品道新象</li>
					</ul>
					<a href="javascript:if(confirm('http://www.yopindo.com/  点击这里给我发送临时消息'))window.location='http://www.yopindo.com/'" tppabs="http://www.yopindo.com/" class="btn_blue" target="_blank" rel="external nofollow">VISIT SITE 访问该网站</a>
					<div class="brief">优品道控股」是中国具有代表性的不动产投资、发展和经营企业，致力于中国优品生活的缔造，是城市区域价值的提升者。
「优品道控股」品牌蕴含 “思于优，行由品，立为道”的企业精神，</div>
				</div>
			</div>
			<div id="detailed">
				<img alt="" src="../../assets/uploads/allimg/131102/1-131102210017.png" tppabs="http://mc18.eatdou.com/uploads/allimg/131102/1-131102210017.png" /><img alt="" src="../../assets/uploads/allimg/131102/1-131102210017-50.png" tppabs="http://mc18.eatdou.com/uploads/allimg/131102/1-131102210017-50.png" /><img alt="" src="../../assets/uploads/allimg/131102/1-131102210018.png" tppabs="http://mc18.eatdou.com/uploads/allimg/131102/1-131102210018.png" />					
			</div>
		</div>
	</article>
	<div id="case_footer">
