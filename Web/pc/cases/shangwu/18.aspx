<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="18.aspx.cs" Inherits="Tc.Web.m.cases.shangwu._18" %>
...
<title>成都朗鲲商务服务顾问有限公司_我的网站</title>
<meta name="keywords" content="成都朗鲲商务服务顾问有限公司" />
<meta name="description" content="朗鲲作为MICE的专门服务机构，自创立以来凭借专业的技能、丰富的经验、对市场敏锐的触觉及对客户需求的了解, 以最前沿的设计理念和高度的敬业精神跻身于最具竞争力的会务公司行列。" />     
	...
	<article>
		<div class="wrapper">
			<div id="overview">
				...
				<div id="case_info">
																																							<h1><img src="../../assets/uploads/131102/1-131102202025522.png" tppabs="http://mc18.eatdou.com/uploads/131102/1-131102202025522.png" width="180" height="120" alt="成都朗鲲商务服务顾问有限公司" /></h1>
					<ul>
						<li>名称：成都朗鲲商务服务顾问有限公司</li>
						<li>分类：电子商务</li>
						<li>TAG：食品优品道新象</li>
					</ul>
					<a href="javascript:if(confirm('http://www.lang-kun.com/  点击这里给我发送临时消息'))window.location='http://www.lang-kun.com/'" tppabs="http://www.lang-kun.com/" class="btn_blue" target="_blank" rel="external nofollow">VISIT SITE 访问该网站</a>
					<div class="brief">朗鲲作为MICE的专门服务机构，自创立以来凭借专业的技能、丰富的经验、对市场敏锐的触觉及对客户需求的了解, 以最前沿的设计理念和高度的敬业精神跻身于最具竞争力的会务公司行列。</div>
				</div>
			</div>
			<div id="detailed">
				<img alt="" src="../../assets/uploads/allimg/131102/1-131102202125G2.png" tppabs="http://mc18.eatdou.com/uploads/allimg/131102/1-131102202125G2.png" style="width: 700px; height: 540px;" />					
			</div>
		</div>
	</article>
	<div id="case_footer">
