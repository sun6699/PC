<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22.aspx.cs" Inherits="Tc.Web.m.cases.gov._22" %>
	...
	<article>
		<div class="wrapper">
			<div id="overview">
				...
				<div id="case_info">
																																							<h1><img src="../../assets/uploads/131102/1-131102210430T2.png" tppabs="http://mc18.eatdou.com/uploads/131102/1-131102210430T2.png" width="180" height="120" alt="成都城市设计研究中心" /></h1>
					<ul>
						<li>名称：成都城市设计研究中心</li>
						<li>分类：学校政府</li>
						<li>TAG：食品优品道新象</li>
					...
					<div class="brief">成都市城市设计研究中心（英文缩写：CDUDC）是以城市设计和研究为主要方向的研究性机构，提供以城市运营为着眼点的相关咨询服务。是整合各方设计、咨询、研究资源的合作平台。为政府决</div>
				</div>
			</div>
			<div id="detailed">
				<img alt="" src="../../assets/uploads/allimg/131102/1-131102210508.jpg" tppabs="http://mc18.eatdou.com/uploads/allimg/131102/1-131102210508.jpg" /><img alt="" src="../../assets/uploads/allimg/131102/1-131102210509.jpg" tppabs="http://mc18.eatdou.com/uploads/allimg/131102/1-131102210509.jpg" /><img alt="" src="../../assets/uploads/allimg/131102/1-131102210509-50.jpg" tppabs="http://mc18.eatdou.com/uploads/allimg/131102/1-131102210509-50.jpg" />					
			</div>
		</div>
	</article>
	<div id="case_footer">
