<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" ValidateRequest="false" Inherits="Tc.WebAdmin.root.shipin.info" %>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txt_url" runat="server" required class="form-control" placeholder="视频链接"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group" style="display: none">
                                <label class="col-sm-2 control-label">标签*</label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txt_seotitle" runat="server" class="form-control" placeholder="以逗号隔开每个标签"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group" style="display:none">
