<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="Tc.Web.root.links.list" %>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="list.aspx?types=<%=types %>">友情链接管理</a>
                    </li>
                </ol>
            </div>
        </div>
                                            ...
                                            <ItemTemplate>
                                                <tr class="gradeA">
                                                    ...
                                                    <td class="actions">
                                                        ...
                                                        <span class="dis">
                                                            <asp:LinkButton ID="lbtnDel" runat="server" OnClientClick="return confirm('确认删除？')"
                                                                CommandArgument='<%#Eval("ID") %>' CssClass="ml10" OnClick="lbtnDel_Click">删除</asp:LinkButton></span>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
