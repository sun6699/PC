<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" ValidateRequest="false" Inherits="Tc.WebAdmin.root.duotu.info" %>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="list.aspx?types=<%=types %>">产品列表</a>
                    </li>
                    <li>
                        <strong>产品信息</strong>
                    </li>
