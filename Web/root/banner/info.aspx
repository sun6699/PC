<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" ValidateRequest="false" Inherits="Tc.WebAdmin.root.banner.info" %>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="list.aspx?types=<%=types %>">Banner列表列表</a>
                    </li>
                    <li>
                        <strong>文章信息</strong>
                    </li>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txt_click" runat="server" class="form-control" placeholder=""></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">图片*(1200 x 500)</label>
                                <div class="col-sm-8">
