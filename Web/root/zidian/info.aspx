<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" Inherits="Tc.WebAdmin.root.zidian.info" %>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtName" runat="server" required class="form-control" placeholder="名称"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtPaixu" runat="server" class="form-control" placeholder="排序"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
