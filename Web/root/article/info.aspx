<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="info.aspx.cs" ValidateRequest="false" Inherits="Tc.WebAdmin.root.article.info" %>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="list.aspx?types=<%=types %>">文章列表</a>
                    </li>
                    <li>
                        <strong>文章信息</strong>
                    </li>
                ...
                <div class="col-sm-10">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">图片*(1000 x 540)</label>
                                <div class="col-sm-8">
