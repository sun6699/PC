    ...
    <header>
        ...
        <div class="wrapper">
            <h1 class="logo"><a href="../../index.htm" title="">
                <img src="../../images/logo.png" width="213" height="36" alt="" /></a></h1>
            <nav>
                <ul>
        ...
        <article>
            <div class="wrapper">
                <div id="overview">
                    ...
                    <div id="case_info">
                        <h1>
                            <img src="../../uploads/131102/1-1311021SZNS.png" tppabs="http://mc18.eatdou.com/uploads/131102/1-1311021SZNS.png" width="180" height="120" alt="西南财经大学" /></h1>
                        <ul>
                            <li>名称：西南财经大学</li>
                            <li>分类：学校政府</li>
                            <li>TAG：食品优品道新象</li>
            ...
            <div class="wrapper">
                ...
                <p>
                    <a target="_blank" href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=89091392&site=qq&menu=yes  点击这里给我发送临时消息'))window.location='http://wpa.qq.com/msgrd?v=3&uin=89091392&site=qq&menu=yes'">
                        <img border="0" src="../../images/qq.png" alt="点击这里给我发消息" title="点击这里给我发消息" /></a><br />
                    电话：400 8888 8888<br />
                    传真：400 8888 8888<br />
                    电子邮件：admin@u.com<br />
