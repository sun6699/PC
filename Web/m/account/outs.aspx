<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="outs.aspx.cs" Inherits="Tc.Web.m.account.outs" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="aui-card-list">
                <div class="aui-card-list-content-padded">
                    <div class=" aui-margin-15">
                        ...
                        <h5 style="text-align: center;">年度支出</h5>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="aui-bar aui-bar-tab" id="footer">
            <div class="aui-bar-tab-item aui-active" onclick="javascript:location.href='outs.aspx'">
